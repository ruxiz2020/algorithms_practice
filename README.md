...
|6|Medium|[ZigZag Conversion](https://leetcode.com/problems/zigzag-conversion/) | Input: s = "PAYPALISHIRING", numRows = 3
Output: "PAHNAPLSIIGYIR" <br>P   A   H   N<br>
A P L S I I G<br>
Y   I   R| [Python (first figure out interval from number of rows)](zigzag_conversion.py)|
